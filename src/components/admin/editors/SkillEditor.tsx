...
const CATEGORIES = ['testing', 'frontend', 'backend', 'devops', 'tools', 'design', 'soft-skills'] as const
          ...
          {categorySkills.map(skill => (
            ...
            >
              ...
              <div className="flex gap-0.5">
                {[1, 2, 3, 4, 5].map(star => (
                  <button
                    ...
                    className={`min-h-11 min-w-7 transition-colors text-[10px] ${
              ...
              <button
                ...
                className="flex min-h-11 min-w-11 items-center justify-center rounded text-gray-600 transition-colors hover:bg-red-500/10 hover:text-red-400"
              >
                <Trash2 size={10} />
              </button>
            </motion.div>
